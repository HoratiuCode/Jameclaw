...
CONTAINER_NAME="jameclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.jameclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run jameclaw:"
echo "  cd packages/jameclaw && go run ./cmd/jameclaw gateway"
echo ""
