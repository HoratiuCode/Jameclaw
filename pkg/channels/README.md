# JameClaw Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/jameclaw/internal/gateway/`
...
4. **Jame Protocol**: `pkg/channels/jame/` implements a custom JameClaw native protocol channel that receives messages via WebSocket webhook (`/jame/ws`).
