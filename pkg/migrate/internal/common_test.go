...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.jameclaw")
	assert.Equal(t, "/home/user/.jameclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.jameclaw/workspace/file.txt", "/home/user/.jameclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".jameclaw"), result)
}
