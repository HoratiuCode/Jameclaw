...
type SubTurnConfig struct {
	MaxDepth              int `json:"max_depth"               env:"JAMECLAW_AGENTS_DEFAULTS_SUBTURN_MAX_DEPTH"`
	MaxConcurrent         int `json:"max_concurrent"          env:"JAMECLAW_AGENTS_DEFAULTS_SUBTURN_MAX_CONCURRENT"`
	DefaultTimeoutMinutes int `json:"default_timeout_minutes" env:"JAMECLAW_AGENTS_DEFAULTS_SUBTURN_DEFAULT_TIMEOUT_MINUTES"`
	DefaultTokenBudget    int `json:"default_token_budget"    env:"JAMECLAW_AGENTS_DEFAULTS_SUBTURN_DEFAULT_TOKEN_BUDGET"`
	ConcurrencyTimeoutSec int `json:"concurrency_timeout_sec" env:"JAMECLAW_AGENTS_DEFAULTS_SUBTURN_CONCURRENCY_TIMEOUT_SEC"`
}

type ToolFeedbackConfig struct {
	Enabled       bool `json:"enabled"         env:"JAMECLAW_AGENTS_DEFAULTS_TOOL_FEEDBACK_ENABLED"`
...
type StreamingConfig struct {
	Enabled         bool `json:"enabled,omitempty"          env:"JAMECLAW_CHANNELS_TELEGRAM_STREAMING_ENABLED"`
	ThrottleSeconds int  `json:"throttle_seconds,omitempty" env:"JAMECLAW_CHANNELS_TELEGRAM_STREAMING_THROTTLE_SECONDS"`
...
type WhatsAppConfig struct {
	...
	UseNative          bool                `json:"use_native"           env:"JAMECLAW_CHANNELS_WHATSAPP_USE_NATIVE"`
	SessionStorePath   string              `json:"session_store_path"   env:"JAMECLAW_CHANNELS_WHATSAPP_SESSION_STORE_PATH"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"           env:"JAMECLAW_CHANNELS_WHATSAPP_ALLOW_FROM"`
	ReasoningChannelID string              `json:"reasoning_channel_id" env:"JAMECLAW_CHANNELS_WHATSAPP_REASONING_CHANNEL_ID"`
}
...
type FeishuConfig struct {
	Enabled             bool   `json:"enabled"                 env:"JAMECLAW_CHANNELS_FEISHU_ENABLED"`
	AppID               string `json:"app_id"                  env:"JAMECLAW_CHANNELS_FEISHU_APP_ID"`
	appSecret           string
	encryptKey          string
	verificationToken   string
	AllowFrom           FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_FEISHU_ALLOW_FROM"`
	GroupTrigger        GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Placeholder         PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID  string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_FEISHU_REASONING_CHANNEL_ID"`
	RandomReactionEmoji FlexibleStringSlice `json:"random_reaction_emoji"   env:"JAMECLAW_CHANNELS_FEISHU_RANDOM_REACTION_EMOJI"`
	IsLark              bool                `json:"is_lark"                 env:"JAMECLAW_CHANNELS_FEISHU_IS_LARK"`
	secDirty            bool
}
...
type DiscordConfig struct {
	Enabled            bool `json:"enabled"                 env:"JAMECLAW_CHANNELS_DISCORD_ENABLED"`
	token              string
	Proxy              string              `json:"proxy"                   env:"JAMECLAW_CHANNELS_DISCORD_PROXY"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_DISCORD_ALLOW_FROM"`
	MentionOnly        bool                `json:"mention_only"            env:"JAMECLAW_CHANNELS_DISCORD_MENTION_ONLY"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Typing             TypingConfig        `json:"typing,omitempty"`
	Placeholder        PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_DISCORD_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type MaixCamConfig struct {
	Enabled            bool                `json:"enabled"              env:"JAMECLAW_CHANNELS_MAIXCAM_ENABLED"`
	Host               string              `json:"host"                 env:"JAMECLAW_CHANNELS_MAIXCAM_HOST"`
	Port               int                 `json:"port"                 env:"JAMECLAW_CHANNELS_MAIXCAM_PORT"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"           env:"JAMECLAW_CHANNELS_MAIXCAM_ALLOW_FROM"`
	ReasoningChannelID string              `json:"reasoning_channel_id" env:"JAMECLAW_CHANNELS_MAIXCAM_REASONING_CHANNEL_ID"`
}

type QQConfig struct {
	Enabled              bool   `json:"enabled"                  env:"JAMECLAW_CHANNELS_QQ_ENABLED"`
	AppID                string `json:"app_id"                   env:"JAMECLAW_CHANNELS_QQ_APP_ID"`
	appSecret            string
	AllowFrom            FlexibleStringSlice `json:"allow_from"               env:"JAMECLAW_CHANNELS_QQ_ALLOW_FROM"`
	GroupTrigger         GroupTriggerConfig  `json:"group_trigger,omitempty"`
	MaxMessageLength     int                 `json:"max_message_length"       env:"JAMECLAW_CHANNELS_QQ_MAX_MESSAGE_LENGTH"`
	MaxBase64FileSizeMiB int64               `json:"max_base64_file_size_mib" env:"JAMECLAW_CHANNELS_QQ_MAX_BASE64_FILE_SIZE_MIB"`
	SendMarkdown         bool                `json:"send_markdown"            env:"JAMECLAW_CHANNELS_QQ_SEND_MARKDOWN"`
	ReasoningChannelID   string              `json:"reasoning_channel_id"     env:"JAMECLAW_CHANNELS_QQ_REASONING_CHANNEL_ID"`
	secDirty             bool
}
...
type DingTalkConfig struct {
	Enabled            bool   `json:"enabled"                 env:"JAMECLAW_CHANNELS_DINGTALK_ENABLED"`
	ClientID           string `json:"client_id"               env:"JAMECLAW_CHANNELS_DINGTALK_CLIENT_ID"`
	clientSecret       string
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_DINGTALK_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_DINGTALK_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type SlackConfig struct {
	Enabled            bool `json:"enabled"                 env:"JAMECLAW_CHANNELS_SLACK_ENABLED"`
	botToken           string
	appToken           string
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_SLACK_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Typing             TypingConfig        `json:"typing,omitempty"`
	Placeholder        PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_SLACK_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type MatrixConfig struct {
	Enabled            bool   `json:"enabled"                  env:"JAMECLAW_CHANNELS_MATRIX_ENABLED"`
	Homeserver         string `json:"homeserver"               env:"JAMECLAW_CHANNELS_MATRIX_HOMESERVER"`
	UserID             string `json:"user_id"                  env:"JAMECLAW_CHANNELS_MATRIX_USER_ID"`
	accessToken        string
	DeviceID           string              `json:"device_id,omitempty"      env:"JAMECLAW_CHANNELS_MATRIX_DEVICE_ID"`
	JoinOnInvite       bool                `json:"join_on_invite"           env:"JAMECLAW_CHANNELS_MATRIX_JOIN_ON_INVITE"`
	MessageFormat      string              `json:"message_format,omitempty" env:"JAMECLAW_CHANNELS_MATRIX_MESSAGE_FORMAT"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"               env:"JAMECLAW_CHANNELS_MATRIX_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Placeholder        PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"     env:"JAMECLAW_CHANNELS_MATRIX_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type LINEConfig struct {
	Enabled            bool `json:"enabled"                 env:"JAMECLAW_CHANNELS_LINE_ENABLED"`
	channelSecret      string
	channelAccessToken string
	WebhookHost        string              `json:"webhook_host"            env:"JAMECLAW_CHANNELS_LINE_WEBHOOK_HOST"`
	WebhookPort        int                 `json:"webhook_port"            env:"JAMECLAW_CHANNELS_LINE_WEBHOOK_PORT"`
	WebhookPath        string              `json:"webhook_path"            env:"JAMECLAW_CHANNELS_LINE_WEBHOOK_PATH"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_LINE_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Typing             TypingConfig        `json:"typing,omitempty"`
	Placeholder        PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_LINE_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type OneBotConfig struct {
	Enabled            bool   `json:"enabled"                 env:"JAMECLAW_CHANNELS_ONEBOT_ENABLED"`
	WSUrl              string `json:"ws_url"                  env:"JAMECLAW_CHANNELS_ONEBOT_WS_URL"`
	accessToken        string
	ReconnectInterval  int                 `json:"reconnect_interval"      env:"JAMECLAW_CHANNELS_ONEBOT_RECONNECT_INTERVAL"`
	GroupTriggerPrefix []string            `json:"group_trigger_prefix"    env:"JAMECLAW_CHANNELS_ONEBOT_GROUP_TRIGGER_PREFIX"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_ONEBOT_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Typing             TypingConfig        `json:"typing,omitempty"`
	Placeholder        PlaceholderConfig   `json:"placeholder,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_ONEBOT_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type WeComConfig struct {
	Enabled            bool `json:"enabled"                 env:"JAMECLAW_CHANNELS_WECOM_ENABLED"`
	token              string
	encodingAESKey     string
	WebhookURL         string              `json:"webhook_url"             env:"JAMECLAW_CHANNELS_WECOM_WEBHOOK_URL"`
	WebhookHost        string              `json:"webhook_host"            env:"JAMECLAW_CHANNELS_WECOM_WEBHOOK_HOST"`
	WebhookPort        int                 `json:"webhook_port"            env:"JAMECLAW_CHANNELS_WECOM_WEBHOOK_PORT"`
	WebhookPath        string              `json:"webhook_path"            env:"JAMECLAW_CHANNELS_WECOM_WEBHOOK_PATH"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_WECOM_ALLOW_FROM"`
	ReplyTimeout       int                 `json:"reply_timeout"           env:"JAMECLAW_CHANNELS_WECOM_REPLY_TIMEOUT"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_WECOM_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type WeComAppConfig struct {
	Enabled            bool   `json:"enabled"                 env:"JAMECLAW_CHANNELS_WECOM_APP_ENABLED"`
	CorpID             string `json:"corp_id"                 env:"JAMECLAW_CHANNELS_WECOM_APP_CORP_ID"`
	corpSecret         string
	AgentID            int64 `json:"agent_id"                env:"JAMECLAW_CHANNELS_WECOM_APP_AGENT_ID"`
	token              string
	encodingAESKey     string
	WebhookHost        string              `json:"webhook_host"            env:"JAMECLAW_CHANNELS_WECOM_APP_WEBHOOK_HOST"`
	WebhookPort        int                 `json:"webhook_port"            env:"JAMECLAW_CHANNELS_WECOM_APP_WEBHOOK_PORT"`
	WebhookPath        string              `json:"webhook_path"            env:"JAMECLAW_CHANNELS_WECOM_APP_WEBHOOK_PATH"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_WECOM_APP_ALLOW_FROM"`
	ReplyTimeout       int                 `json:"reply_timeout"           env:"JAMECLAW_CHANNELS_WECOM_APP_REPLY_TIMEOUT"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_WECOM_APP_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type WeComAIBotConfig struct {
	Enabled            bool   `json:"enabled"                      env:"JAMECLAW_CHANNELS_WECOM_AIBOT_ENABLED"`
	BotID              string `json:"bot_id,omitempty"             env:"JAMECLAW_CHANNELS_WECOM_AIBOT_BOT_ID"`
	secret             string
	token              string
	encodingAESKey     string
	WebhookPath        string              `json:"webhook_path,omitempty"       env:"JAMECLAW_CHANNELS_WECOM_AIBOT_WEBHOOK_PATH"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"                   env:"JAMECLAW_CHANNELS_WECOM_AIBOT_ALLOW_FROM"`
	ReplyTimeout       int                 `json:"reply_timeout"                env:"JAMECLAW_CHANNELS_WECOM_AIBOT_REPLY_TIMEOUT"`
	MaxSteps           int                 `json:"max_steps"                    env:"JAMECLAW_CHANNELS_WECOM_AIBOT_MAX_STEPS"`       // Maximum streaming steps
	WelcomeMessage     string              `json:"welcome_message"              env:"JAMECLAW_CHANNELS_WECOM_AIBOT_WELCOME_MESSAGE"` // Sent on enter_chat event; empty = no welcome
	ProcessingMessage  string              `json:"processing_message,omitempty" env:"JAMECLAW_CHANNELS_WECOM_AIBOT_PROCESSING_MESSAGE"`
	ReasoningChannelID string              `json:"reasoning_channel_id"         env:"JAMECLAW_CHANNELS_WECOM_AIBOT_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type WeixinConfig struct {
	Enabled            bool `json:"enabled"              env:"JAMECLAW_CHANNELS_WEIXIN_ENABLED"`
	token              string
	BaseURL            string              `json:"base_url"             env:"JAMECLAW_CHANNELS_WEIXIN_BASE_URL"`
	CDNBaseURL         string              `json:"cdn_base_url"         env:"JAMECLAW_CHANNELS_WEIXIN_CDN_BASE_URL"`
	Proxy              string              `json:"proxy"                env:"JAMECLAW_CHANNELS_WEIXIN_PROXY"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"           env:"JAMECLAW_CHANNELS_WEIXIN_ALLOW_FROM"`
	ReasoningChannelID string              `json:"reasoning_channel_id" env:"JAMECLAW_CHANNELS_WEIXIN_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type JameConfig struct {
	Enabled         bool `json:"enabled"                     env:"JAMECLAW_CHANNELS_PICO_ENABLED"`
	token           string
	...
	AllowFrom       FlexibleStringSlice `json:"allow_from"                  env:"JAMECLAW_CHANNELS_PICO_ALLOW_FROM"`
	Placeholder     PlaceholderConfig   `json:"placeholder,omitempty"`
	secDirty        bool
}
...
type JameClientConfig struct {
	Enabled      bool                `json:"enabled"                 env:"JAMECLAW_CHANNELS_PICO_CLIENT_ENABLED"`
	URL          string              `json:"url"                     env:"JAMECLAW_CHANNELS_PICO_CLIENT_URL"`
	Token        string              `json:"token"                   env:"JAMECLAW_CHANNELS_PICO_CLIENT_TOKEN"`
	SessionID    string              `json:"session_id,omitempty"`
	PingInterval int                 `json:"ping_interval,omitempty"`
	ReadTimeout  int                 `json:"read_timeout,omitempty"`
	AllowFrom    FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_PICO_CLIENT_ALLOW_FROM"`
}

type IRCConfig struct {
	Enabled            bool   `json:"enabled"                 env:"JAMECLAW_CHANNELS_IRC_ENABLED"`
	Server             string `json:"server"                  env:"JAMECLAW_CHANNELS_IRC_SERVER"`
	TLS                bool   `json:"tls"                     env:"JAMECLAW_CHANNELS_IRC_TLS"`
	Nick               string `json:"nick"                    env:"JAMECLAW_CHANNELS_IRC_NICK"`
	User               string `json:"user,omitempty"          env:"JAMECLAW_CHANNELS_IRC_USER"`
	RealName           string `json:"real_name,omitempty"     env:"JAMECLAW_CHANNELS_IRC_REAL_NAME"`
	password           string
	nickServPassword   string
	SASLUser           string `json:"sasl_user"               env:"JAMECLAW_CHANNELS_IRC_SASL_USER"`
	saslPassword       string
	Channels           FlexibleStringSlice `json:"channels"                env:"JAMECLAW_CHANNELS_IRC_CHANNELS"`
	RequestCaps        FlexibleStringSlice `json:"request_caps,omitempty"  env:"JAMECLAW_CHANNELS_IRC_REQUEST_CAPS"`
	AllowFrom          FlexibleStringSlice `json:"allow_from"              env:"JAMECLAW_CHANNELS_IRC_ALLOW_FROM"`
	GroupTrigger       GroupTriggerConfig  `json:"group_trigger,omitempty"`
	Typing             TypingConfig        `json:"typing,omitempty"`
	ReasoningChannelID string              `json:"reasoning_channel_id"    env:"JAMECLAW_CHANNELS_IRC_REASONING_CHANNEL_ID"`
	secDirty           bool
}
...
type GatewayConfig struct {
	Host      string `json:"host"                env:"JAMECLAW_GATEWAY_HOST"`
	Port      int    `json:"port"                env:"JAMECLAW_GATEWAY_PORT"`
	HotReload bool   `json:"hot_reload"          env:"JAMECLAW_GATEWAY_HOT_RELOAD"`
	LogLevel  string `json:"log_level,omitempty" env:"JAMECLAW_LOG_LEVEL"`
}

type ToolDiscoveryConfig struct {
	Enabled          bool `json:"enabled"            env:"JAMECLAW_TOOLS_DISCOVERY_ENABLED"`
	TTL              int  `json:"ttl"                env:"JAMECLAW_TOOLS_DISCOVERY_TTL"`
	MaxSearchResults int  `json:"max_search_results" env:"JAMECLAW_MAX_SEARCH_RESULTS"`
	UseBM25          bool `json:"use_bm25"           env:"JAMECLAW_TOOLS_DISCOVERY_USE_BM25"`
	UseRegex         bool `json:"use_regex"          env:"JAMECLAW_TOOLS_DISCOVERY_USE_REGEX"`
}
...
type BraveConfig struct {
	Enabled    bool `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_BRAVE_ENABLED"`
	apiKeys    []string
	secDirty   bool
	MaxResults int `json:"max_results" env:"JAMECLAW_TOOLS_WEB_BRAVE_MAX_RESULTS"`
}
...
type TavilyConfig struct {
	Enabled    bool `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_TAVILY_ENABLED"`
	apiKeys    []string
	secDirty   bool
	BaseURL    string `json:"base_url"    env:"JAMECLAW_TOOLS_WEB_TAVILY_BASE_URL"`
	MaxResults int    `json:"max_results" env:"JAMECLAW_TOOLS_WEB_TAVILY_MAX_RESULTS"`
}
...
type DuckDuckGoConfig struct {
	Enabled    bool `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_DUCKDUCKGO_ENABLED"`
	MaxResults int  `json:"max_results" env:"JAMECLAW_TOOLS_WEB_DUCKDUCKGO_MAX_RESULTS"`
}

type PerplexityConfig struct {
	Enabled    bool `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_PERPLEXITY_ENABLED"`
	apiKeys    []string
	secDirty   bool
	MaxResults int `json:"max_results" env:"JAMECLAW_TOOLS_WEB_PERPLEXITY_MAX_RESULTS"`
}
...
type SearXNGConfig struct {
	Enabled    bool   `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_SEARXNG_ENABLED"`
	BaseURL    string `json:"base_url"    env:"JAMECLAW_TOOLS_WEB_SEARXNG_BASE_URL"`
	MaxResults int    `json:"max_results" env:"JAMECLAW_TOOLS_WEB_SEARXNG_MAX_RESULTS"`
}

type GLMSearchConfig struct {
	Enabled  bool `json:"enabled"  env:"JAMECLAW_TOOLS_WEB_GLM_ENABLED"`
	apiKey   string
	secDirty bool
	BaseURL  string `json:"base_url" env:"JAMECLAW_TOOLS_WEB_GLM_BASE_URL"`
	// SearchEngine specifies the search backend: "search_std" (default),
	// "search_pro", "search_pro_sogou", or "search_pro_quark".
	SearchEngine string `json:"search_engine" env:"JAMECLAW_TOOLS_WEB_GLM_SEARCH_ENGINE"`
	MaxResults   int    `json:"max_results"   env:"JAMECLAW_TOOLS_WEB_GLM_MAX_RESULTS"`
}
...
type BaiduSearchConfig struct {
	Enabled    bool   `json:"enabled"     env:"JAMECLAW_TOOLS_WEB_BAIDU_ENABLED"`
	BaseURL    string `json:"base_url"    env:"JAMECLAW_TOOLS_WEB_BAIDU_BASE_URL"`
	MaxResults int    `json:"max_results" env:"JAMECLAW_TOOLS_WEB_BAIDU_MAX_RESULTS"`
	apiKey     string
	secDirty   bool
}
...
type WebToolsConfig struct {
	ToolConfig  `                  envPrefix:"JAMECLAW_TOOLS_WEB_"`
	...
	PreferNative bool `json:"prefer_native" env:"JAMECLAW_TOOLS_WEB_PREFER_NATIVE"`
	// Proxy is an optional proxy URL for web tools (http/https/socks5/socks5h).
	// For authenticated proxies, prefer HTTP_PROXY/HTTPS_PROXY env vars instead of embedding credentials in config.
	Proxy                string              `json:"proxy,omitempty"                  env:"JAMECLAW_TOOLS_WEB_PROXY"`
	FetchLimitBytes      int64               `json:"fetch_limit_bytes,omitempty"      env:"JAMECLAW_TOOLS_WEB_FETCH_LIMIT_BYTES"`
	Format               string              `json:"format,omitempty"                 env:"JAMECLAW_TOOLS_WEB_FORMAT"`
	PrivateHostWhitelist FlexibleStringSlice `json:"private_host_whitelist,omitempty" env:"JAMECLAW_TOOLS_WEB_PRIVATE_HOST_WHITELIST"`
}

type CronToolsConfig struct {
	ToolConfig         `     envPrefix:"JAMECLAW_TOOLS_CRON_"`
	ExecTimeoutMinutes int  `                                 env:"JAMECLAW_TOOLS_CRON_EXEC_TIMEOUT_MINUTES" json:"exec_timeout_minutes"` // 0 means no timeout
	AllowCommand       bool `                                 env:"JAMECLAW_TOOLS_CRON_ALLOW_COMMAND"        json:"allow_command"`
}

type ExecConfig struct {
	ToolConfig          `         envPrefix:"JAMECLAW_TOOLS_EXEC_"`
	EnableDenyPatterns  bool     `                                 env:"JAMECLAW_TOOLS_EXEC_ENABLE_DENY_PATTERNS"  json:"enable_deny_patterns"`
	AllowRemote         bool     `                                 env:"JAMECLAW_TOOLS_EXEC_ALLOW_REMOTE"          json:"allow_remote"`
	CustomDenyPatterns  []string `                                 env:"JAMECLAW_TOOLS_EXEC_CUSTOM_DENY_PATTERNS"  json:"custom_deny_patterns"`
	CustomAllowPatterns []string `                                 env:"JAMECLAW_TOOLS_EXEC_CUSTOM_ALLOW_PATTERNS" json:"custom_allow_patterns"`
	TimeoutSeconds      int      `                                 env:"JAMECLAW_TOOLS_EXEC_TIMEOUT_SECONDS"       json:"timeout_seconds"` // 0 means use default (60s)
}

type SkillsToolsConfig struct {
	ToolConfig            `                       envPrefix:"JAMECLAW_TOOLS_SKILLS_"`
	Registries            SkillsRegistriesConfig `                                   json:"registries"`
	Github                SkillsGithubConfig     `                                   json:"github"`
	MaxConcurrentSearches int                    `                                   json:"max_concurrent_searches" env:"JAMECLAW_TOOLS_SKILLS_MAX_CONCURRENT_SEARCHES"`
	SearchCache           SearchCacheConfig      `                                   json:"search_cache"`
}

type MediaCleanupConfig struct {
	ToolConfig `    envPrefix:"JAMECLAW_MEDIA_CLEANUP_"`
	MaxAge     int `                                    env:"JAMECLAW_MEDIA_CLEANUP_MAX_AGE"  json:"max_age_minutes"`
	Interval   int `                                    env:"JAMECLAW_MEDIA_CLEANUP_INTERVAL" json:"interval_minutes"`
}
...
type ToolsConfig struct {
	...
	FilterSensitiveData bool `json:"filter_sensitive_data" env:"JAMECLAW_TOOLS_FILTER_SENSITIVE_DATA"`
...
type SearchCacheConfig struct {
	MaxSize    int `json:"max_size"    env:"JAMECLAW_SKILLS_SEARCH_CACHE_MAX_SIZE"`
	TTLSeconds int `json:"ttl_seconds" env:"JAMECLAW_SKILLS_SEARCH_CACHE_TTL_SECONDS"`
}
...
type SkillsGithubConfig struct {
	token    string
	secDirty bool
	Proxy    string `json:"proxy,omitempty" env:"JAMECLAW_TOOLS_SKILLS_GITHUB_PROXY"`
}
...
type ClawHubRegistryConfig struct {
	Enabled         bool   `json:"enabled"           env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_ENABLED"`
	BaseURL         string `json:"base_url"          env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_BASE_URL"`
	authToken       string
	secDirty        bool
	SearchPath      string `json:"search_path"       env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_SEARCH_PATH"`
	SkillsPath      string `json:"skills_path"       env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_SKILLS_PATH"`
	DownloadPath    string `json:"download_path"     env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_DOWNLOAD_PATH"`
	Timeout         int    `json:"timeout"           env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_TIMEOUT"`
	MaxZipSize      int    `json:"max_zip_size"      env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_MAX_ZIP_SIZE"`
	MaxResponseSize int    `json:"max_response_size" env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_MAX_RESPONSE_SIZE"`
}
...
type MCPConfig struct {
	ToolConfig `                    envPrefix:"JAMECLAW_TOOLS_MCP_"`
...
func LoadConfig(path string) (*Config, error) {
			...
			for _, k := range m.apiKeys {
				if k != "" && !strings.HasPrefix(k, "enc://") && !strings.HasPrefix(k, "file://") {
					fmt.Fprintf(os.Stderr,
						"jameclaw: warning: model %q has a plaintext api_key; call SaveConfig to encrypt it\n",
						m.ModelName)
	...
	if cfg.Agents.Defaults.Workspace == "" {
		...
		if jameclawHome := os.Getenv(EnvHome); jameclawHome != "" {
			homePath = jameclawHome
		} else if homePath != "" {
			homePath = filepath.Join(homePath, pkg.DefaultJameClawHome)
		}
