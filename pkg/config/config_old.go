...
type agentDefaultsV0 struct {
	...
	ModelName                 string         `json:"model_name,omitempty"            env:"JAMECLAW_AGENTS_DEFAULTS_MODEL_NAME"`
	Model                     string         `json:"model"                           env:"JAMECLAW_AGENTS_DEFAULTS_MODEL"` // Deprecated: use model_name instead
...
type qqConfigV0 struct {
	...
	AppSecret            string              `json:"app_secret"               env:"JAMECLAW_CHANNELS_QQ_APP_SECRET"`
...
type telegramConfigV0 struct {
	...
	Token              string              `json:"token"                   env:"JAMECLAW_CHANNELS_TELEGRAM_TOKEN"`
...
type feishuConfigV0 struct {
	...
	AppSecret           string              `json:"app_secret"              env:"JAMECLAW_CHANNELS_FEISHU_APP_SECRET"`
	EncryptKey          string              `json:"encrypt_key"             env:"JAMECLAW_CHANNELS_FEISHU_ENCRYPT_KEY"`
	VerificationToken   string              `json:"verification_token"      env:"JAMECLAW_CHANNELS_FEISHU_VERIFICATION_TOKEN"`
...
type discordConfigV0 struct {
	...
	Token              string              `json:"token"                   env:"JAMECLAW_CHANNELS_DISCORD_TOKEN"`
...
type dingtalkConfigV0 struct {
	...
	ClientSecret       string              `json:"client_secret"           env:"JAMECLAW_CHANNELS_DINGTALK_CLIENT_SECRET"`
...
type slackConfigV0 struct {
	...
	BotToken           string              `json:"bot_token"               env:"JAMECLAW_CHANNELS_SLACK_BOT_TOKEN"`
	AppToken           string              `json:"app_token"               env:"JAMECLAW_CHANNELS_SLACK_APP_TOKEN"`
...
type matrixConfigV0 struct {
	...
	AccessToken        string              `json:"access_token"             env:"JAMECLAW_CHANNELS_MATRIX_ACCESS_TOKEN"`
...
type lineConfigV0 struct {
	...
	ChannelSecret      string              `json:"channel_secret"          env:"JAMECLAW_CHANNELS_LINE_CHANNEL_SECRET"`
	ChannelAccessToken string              `json:"channel_access_token"    env:"JAMECLAW_CHANNELS_LINE_CHANNEL_ACCESS_TOKEN"`
...
type onebotConfigV0 struct {
	...
	AccessToken        string              `json:"access_token"            env:"JAMECLAW_CHANNELS_ONEBOT_ACCESS_TOKEN"`
...
type wecomConfigV0 struct {
	...
	Token              string              `json:"token"                   env:"JAMECLAW_CHANNELS_WECOM_TOKEN"`
	EncodingAESKey     string              `json:"encoding_aes_key"        env:"JAMECLAW_CHANNELS_WECOM_ENCODING_AES_KEY"`
...
type weixinConfigV0 struct {
	...
	Token              string              `json:"token"                env:"JAMECLAW_CHANNELS_WEIXIN_TOKEN"`
...
type wecomappConfigV0 struct {
	...
	CorpSecret         string              `json:"corp_secret"             env:"JAMECLAW_CHANNELS_WECOM_APP_CORP_SECRET"`
	AgentID            int64               `json:"agent_id"                env:"JAMECLAW_CHANNELS_WECOM_APP_AGENT_ID"`
	Token              string              `json:"token"                   env:"JAMECLAW_CHANNELS_WECOM_APP_TOKEN"`
	EncodingAESKey     string              `json:"encoding_aes_key"        env:"JAMECLAW_CHANNELS_WECOM_APP_ENCODING_AES_KEY"`
...
type wecomaibotConfigV0 struct {
	...
	Token              string              `json:"token"                env:"JAMECLAW_CHANNELS_WECOM_AIBOT_TOKEN"`
	Secret             string              `json:"secret"               env:"JAMECLAW_CHANNELS_WECOM_AIBOT_SECRET"`
	EncodingAESKey     string              `json:"encoding_aes_key"     env:"JAMECLAW_CHANNELS_WECOM_AIBOT_ENCODING_AES_KEY"`
	WebhookPath        string              `json:"webhook_path"         env:"JAMECLAW_CHANNELS_WECOM_AIBOT_WEBHOOK_PATH"`
	...
	MaxSteps           int                 `json:"max_steps"            env:"JAMECLAW_CHANNELS_WECOM_AIBOT_MAX_STEPS"`
	WelcomeMessage     string              `json:"welcome_message"      env:"JAMECLAW_CHANNELS_WECOM_AIBOT_WELCOME_MESSAGE"`
...
type jameConfigV0 struct {
	...
	Token           string              `json:"token"                       env:"JAMECLAW_CHANNELS_PICO_TOKEN"`
...
type ircConfigV0 struct {
	...
	Password           string              `json:"password"                env:"JAMECLAW_CHANNELS_IRC_PASSWORD"`
	NickServPassword   string              `json:"nickserv_password"       env:"JAMECLAW_CHANNELS_IRC_NICKSERV_PASSWORD"`
	SASLUser           string              `json:"sasl_user"               env:"JAMECLAW_CHANNELS_IRC_SASL_USER"`
	SASLPassword       string              `json:"sasl_password"           env:"JAMECLAW_CHANNELS_IRC_SASL_PASSWORD"`
...
type providerConfigV0 struct {
	APIKey         string `json:"api_key"                   env:"JAMECLAW_PROVIDERS_{{.Name}}_API_KEY"`
	APIBase        string `json:"api_base"                  env:"JAMECLAW_PROVIDERS_{{.Name}}_API_BASE"`
	Proxy          string `json:"proxy,omitempty"           env:"JAMECLAW_PROVIDERS_{{.Name}}_PROXY"`
	RequestTimeout int    `json:"request_timeout,omitempty" env:"JAMECLAW_PROVIDERS_{{.Name}}_REQUEST_TIMEOUT"`
	AuthMethod     string `json:"auth_method,omitempty"     env:"JAMECLAW_PROVIDERS_{{.Name}}_AUTH_METHOD"`
	ConnectMode    string `json:"connect_mode,omitempty"    env:"JAMECLAW_PROVIDERS_{{.Name}}_CONNECT_MODE"` // only for Github Copilot, `stdio` or `grpc`
}
...
type openAIProviderConfigV0 struct {
	providerConfigV0
	WebSearch bool `json:"web_search" env:"JAMECLAW_PROVIDERS_OPENAI_WEB_SEARCH"`
}
...
type braveConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"JAMECLAW_TOOLS_WEB_BRAVE_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"JAMECLAW_TOOLS_WEB_BRAVE_API_KEYS"`
...
type tavilyConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"JAMECLAW_TOOLS_WEB_TAVILY_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"JAMECLAW_TOOLS_WEB_TAVILY_API_KEYS"`
...
type perplexityConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"JAMECLAW_TOOLS_WEB_PERPLEXITY_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"JAMECLAW_TOOLS_WEB_PERPLEXITY_API_KEYS"`
...
type glmSearchConfigV0 struct {
	...
	APIKey       string `json:"api_key"       env:"JAMECLAW_TOOLS_WEB_GLM_API_KEY"`
...
type clawHubRegistryConfigV0 struct {
	...
	AuthToken  string `json:"auth_token"  env:"JAMECLAW_SKILLS_REGISTRIES_CLAWHUB_AUTH_TOKEN"`
...
type skillsGithubConfigV0 struct {
	Token string `json:"token"           env:"JAMECLAW_TOOLS_SKILLS_GITHUB_TOKEN"`
