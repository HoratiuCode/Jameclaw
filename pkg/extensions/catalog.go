...
func providerDescriptors() []ProviderDescriptor {
	return []ProviderDescriptor{
		...
		httpProvider("modelscope", "ModelScope", "https://modelscope.cn/", "https://api-inference.modelscope.cn/v1", "modelscope-model", "modelscope/default"),
		{
			...
			Description:    "Nous Portal models through its OpenAI-compatible inference API.",
			DocsURL:        "https://portal.nousresearch.com/",
			Protocols:      []string{"nous"},
			DefaultAPIBase: "https://inference-api.nousresearch.com/v1",
			RequiresAPIKey: true,
			...
			RecommendedModels: []ModelPreset{{
				ID:             "nous-model",
				Name:           "Claude Sonnet 4.6",
				ModelName:      "nous-model",
				Model:          "nous/anthropic/claude-sonnet-4.6",
				APIBase:        "https://inference-api.nousresearch.com/v1",
				RequiresAPIKey: true,
				KeyLabel:       "Nous API key",
				RequestTimeout: 60,
				Description:    "Claude Sonnet 4.6 routed through Nous Portal.",
			}},
			SetupHint: "Paste a Nous Portal API key. The account must have enough Portal credits for the selected model.",
		},
