# 🖥️ JameClaw Hardware Compatibility List

JameClaw runs on virtually any Linux device. This page tracks verified chips, products, and development boards.
...
Consumer products, routers, and industrial devices that have been tested with JameClaw.
...
# 3. Test
./jameclaw agent -m "Hello, what board am I running on?"
```
