...
JameClaw provides QQ support via the official Bot API from the QQ Open Platform.
...
4. Fill in the credentials in the JameClaw configuration file
5. Run `jameclaw gateway` to start the service
