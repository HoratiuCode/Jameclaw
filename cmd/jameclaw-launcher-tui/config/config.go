...
// Package config provides types and I/O for ~/.jameclaw/tui.toml.
package config
...
func DefaultConfigPath() string {
	...
	return filepath.Join(home, ".jameclaw", "tui.toml")
}

// TUIConfig is the top-level structure of ~/.jameclaw/tui.toml.
...
// SyncSelectedModelToMainConfig syncs the currently selected model to ~/.jameclaw/config.json
...
func SyncSelectedModelToMainConfig(scheme Scheme, user User, modelID string) error {
	...
	mainConfigPath := filepath.Join(home, ".jameclaw", "config.json")
