...
to authorize your account. On success, the bot token is saved to the jameclaw
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your jameclaw config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
