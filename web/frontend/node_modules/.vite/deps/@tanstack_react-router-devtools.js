...
import {
  useRouter,
  useRouterState
} from "./chunk-5Z3ZW6YD.js";
import "./chunk-DQM67L74.js";
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) Devtools = this.#Component;
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-B12ktJLj-W56JUA2N.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-B43j38ty-YMZMTATJ.js"));
