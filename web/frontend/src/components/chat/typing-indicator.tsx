    ...
    <div className="flex w-full flex-col gap-1.5">
      ...
      <div className="bg-card inline-flex w-fit max-w-xs flex-col gap-3 rounded-xl border px-5 py-4">
        <div className="flex items-center gap-1.5">
          <span className="size-2 animate-bounce rounded-full bg-[var(--jame-accent-muted)] [animation-delay:-0.3s]" />
          <span className="size-2 animate-bounce rounded-full bg-[var(--jame-accent-muted)] [animation-delay:-0.15s]" />
          <span className="size-2 animate-bounce rounded-full bg-[var(--jame-accent-muted)]" />
        </div>

        <div className="bg-muted relative h-1 w-36 overflow-hidden rounded-full">
          <div className="absolute inset-0 animate-[shimmer_2s_infinite] rounded-full bg-[linear-gradient(90deg,var(--jame-accent-muted),var(--jame-accent),var(--jame-accent-muted))] bg-[length:200%_100%]" />
        </div>
